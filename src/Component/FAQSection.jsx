...
import { Plus, Minus, HelpCircle, Shield, Clock, Users, Search, BookOpen, Globe, Star } from 'lucide-react';
        ...
        general: [
            {
                ...
                answer: "HistoriVault is a premier digital repository of historical artifacts from civilizations across the globe. We combine cutting-edge technology with archaeological expertise to provide detailed documentation, 3D models, and historical context for each artifact. Our collection spans over 5,000 years of human history, making it one of the most comprehensive digital archives available."
            },
            {
                question: "How do you acquire and verify historical artifacts?",
                answer: "All artifacts in our collection are acquired through legitimate channels including museum partnerships, archaeological expeditions, and private donations. Each piece undergoes rigorous authentication by our team of expert archaeologists and historians using advanced dating techniques, provenance research, and scientific analysis."
            },
            {
                question: "Can I visit the physical artifacts or are they only digital?",
                answer: "While HistoriVault primarily serves as a digital platform, many of our featured artifacts are housed in partner museums worldwide. We provide location information and visiting details for physical viewing when available. Some artifacts are exclusively digital due to their fragile nature or restricted access."
            },
            {
                question: "Is HistoriVault suitable for educational purposes?",
                answer: "HistoriVault is designed with educators and students in mind. We offer educational licenses, curriculum integration tools, and detailed historical context for each artifact. Many universities and schools use our platform for history, archaeology, and cultural studies courses."
            }
        ],
        authentication: [
            {
                question: "How do you ensure the authenticity of artifacts?",
                answer: "Our authentication process involves multiple layers of verification including carbon dating, thermoluminescence testing, X-ray analysis, and provenance documentation. Each artifact is examined by at least three independent experts before being added to our collection."
            },
            {
                question: "What happens if an artifact's authenticity is questioned?",
                answer: "We take authenticity concerns very seriously. If new evidence emerges questioning an artifact's authenticity, we immediately launch a comprehensive review involving external experts. Questionable items are flagged or removed until verification is complete."
            },
            {
                question: "Do you work with international heritage organizations?",
                answer: "Yes, we collaborate closely with UNESCO, ICOM, and various national heritage organizations to ensure ethical practices and compliance with international heritage laws. We also support repatriation efforts when appropriate."
            }
        ],
        collection: [
            {
                question: "How often do you add new artifacts to the collection?",
                answer: "We add new artifacts weekly, with major collection updates monthly. Our team is constantly working with archaeological sites, museums, and researchers to expand our offerings. Premium subscribers get early access to new additions."
            },
            {
                question: "Can I suggest artifacts for inclusion in the collection?",
                answer: "We welcome suggestions from our community! You can submit artifact recommendations through our contact form. While we can't guarantee inclusion, our curatorial team reviews all suggestions and may reach out for more information."
            },
            {
                question: "Are there artifacts from all continents and time periods?",
                answer: "Our collection spans all inhabited continents and covers over 5,000 years of history, from prehistoric tools to medieval manuscripts. We're continuously working to ensure balanced representation across cultures and time periods."
            },
            {
                question: "Do you have 3D models and interactive features?",
                answer: "Many of our artifacts feature high-resolution 3D models that you can rotate, zoom, and examine in detail. We also offer AR experiences for select pieces and virtual exhibition tours for premium subscribers."
            }
        ],
        research: [
            {
                question: "Can researchers access detailed documentation?",
                answer: "Researchers can access comprehensive documentation including provenance records, scientific analysis reports, and bibliographic references. Academic researchers may apply for enhanced access to raw data and unpublished research materials."
            },
            {
                question: "Do you support academic research projects?",
                answer: "We actively support academic research through our Scholar Program, which provides free access to researchers, collaboration opportunities, and potential funding for relevant projects. We've supported over 200 research projects to date."
            },
            {
                question: "How can I cite artifacts from HistoriVault in my research?",
                answer: "Each artifact page includes a 'Cite This Artifact' section with properly formatted citations for various academic styles (APA, MLA, Chicago, etc.). We also provide DOI numbers for permanent reference."
            },
            {
                question: "Is there an API for developers and researchers?",
                answer: "Yes, we offer a comprehensive API that allows developers and researchers to access artifact metadata, images, and documentation programmatically. API access is available for academic and non-commercial use with proper attribution."
            }
        ]
    };
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                >
                    ...
                    <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                        Find answers to common questions about our historical artifacts collection,
                        authentication processes, and research capabilities.
                    </p>
                </motion.div>
