...
const AddArtifact = () => {
    ...
    return (
        ...
        >
            {/* // dynamic title add */}
      <Helmet>
        <title>HistoriVault | Update-Artifacts</title>
      </Helmet>
            {/* Background Effects */}
            ...
            <div className="max-w-4xl mx-auto relative z-10">
                ...
                {/* Form */}
                <motion.form
                    onSubmit={handleUpdateArtifacts}
                    className="space-y-8"
                            ...
                            <div className="space-y-6">
                                ...
                                <motion.div variants={itemVariants}>
                                    ...
                                    <motion.div variants={inputVariants} whileFocus="focus" initial="blur">
                                        ...
                                        >
                                            <option defaultValue="" className="bg-gray-800 text-gray-300">
                                                Select artifact type...
                                            </option>
                                            {artifactTypes.map((type) => (
                                                <option key={type} defaultValue={type} className="bg-gray-800 text-white">
                                                    {type}
                                                </option>
                                            ))}
                                        </select>
